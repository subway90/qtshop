                                    ...
                                    <div class="card w-100">
                                        <div class="card-body p-5">
                                            ...
                                            <select name="status" class="sa-select2 form-select">
                                                ...
                                                {
                                                    ?>
                                                <option value="1">Hiện</option><option value="2">Ẩn</option><option value="3">Nổi bật</option>
                                                    <?php
                                                }elseif($slide['status']==3)
                                                {
                                                    ?>
                                                <option value="3">Nổi bật</option><option value="2">Ẩn</option><option value="1">Hiện</option>
                                                    <?php
                                                }
                                                else
                                                {
                                                    ?>
                                                    <option value="2">Ẩn</option><option value="1">Hiện</option><option value="3">Nổi bật</option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="card w-100 mt-5">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="border p-4 d-flex justify-content-center">
                                                <div class="max-w-20x"><img src="./../View/img/<?=$slide['image']?>"
